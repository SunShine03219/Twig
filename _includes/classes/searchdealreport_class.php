...
' . $whereclause . ' )';*/
		...
		$result['info'] = array('amount_financed'=>$totalresult['financed_total'], 'lender'=>'Total', 'stock'=>$totalresult['deals']);
		...
		*/
		...
		$table->add_get_var('action', 'search');
