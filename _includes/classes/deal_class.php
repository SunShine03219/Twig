...
class deal{
	...
	private $warranty_id;
	private $warranty_included;
	private $warranty_sold_outside;
	...
	private $finance_acv;
	private $finance_trade_allowance;
	...
	private function zero_it(){
		...
		$this->flooring_date = '';
		$this->warranty_id = 0;
		$this->warranty_included = 0;
		$this->warranty_sold_outside = 0;
		...
		$this->finance_acv = 0;
		$this->finance_trade_allowance = 0;
	...
	private function populate(){
		...
		$this->set_whole_sale($data['whole_sale']);
		...
		$this->set_down_payment($data['down_payment']);
		$this->set_guarantee($data['guarantee']);
		$this->set_holdback_finance($data['holdback_finance']);
		$this->set_term($data['term']);
		$this->set_rate($data['rate']);
		$this->set_monthly_payment($data['monthly_payment']);
		...
		$this->set_warranty_included($data['warranty_included']);
		$this->set_warranty_sold_outside($data['warranty_sold_outside']);
		...
		$this->set_finance_trade_allowance($data['finance_trade_allowance']);
	...
	public function get_whole_sale(){
	...
	public function get_holdback_finance(){
		return $this->holdback_finance;
	}
	...
	public function get_warranty_included(){
		return $this->warranty_included;
	}

	public function get_warranty_sold_outside(){
		return $this->warranty_sold_outside;
	}
	...
	public function get_finance_trade_allowance(){
		return $this->finance_trade_allowance;
	}
	...
	public function set_whole_sale($v){
		if($v){
			$this->whole_sale = 1;
		}else{
			$this->whole_sale = 0;
	...
	public function set_date_sold($v){
		if(!empty($v) && $v!='0000-00-00'){
			$this->date_sold = date('Y-m-d', strtotime($v));
		}
	}
	...
	public function set_date_sent($v){
		if(!empty($v) && $v!='0000-00-00'){
			$this->date_sent = date('Y-m-d', strtotime($v));
		}
	}
	
	public function set_down_payment($v){
		$this->down_payment = $v;
	}

	public function set_guarantee($v){
		$this->guarantee = $v;
	}

	public function set_holdback_finance($v){
		$this->holdback_finance = $v;
	}
	...
	public function set_rate($v){
		$this->rate = $v;
	}

	public function set_monthly_payment($v){
		$this->monthly_payment = $v;
	}
	...
	public function set_approved_date($v){
		if(!empty($v) && $v!='0000-00-00'){
			$this->approved_date = date('Y-m-d', strtotime($v));
		}
	}
	public function set_funded_date($v){
		if(!empty($v) && $v!='0000-00-00'){
			$this->funded_date = date('Y-m-d', strtotime($v));
		}
	}
	...
	public function set_flooring_date($v){
		if(!empty($v) && $v!='0000-00-00'){
			$this->flooring_date = date('Y-m-d', strtotime($v));
		}
	}
	...
	public function set_warranty_included($v){
		if($v){
			$this->warranty_included = 1;
		}else{
			$this->warranty_included = 0;
		}
	...
	public function set_warranty_sold_outside($v){
		if($v){
			$this->warranty_sold_outside = 1;
		}else{
			$this->warranty_sold_outside = 0;
		}
	...
	public function set_finance_trade_allowance($v){
		$this->finance_trade_allowance = $v;
	}
	...
	public function to_array(){
		...
		$myarray['whole_sale'] = $this->whole_sale;
		...
		$myarray['down_payment'] = $this->down_payment;
		$myarray['guarantee'] = $this->guarantee;
		$myarray['holdback_finance'] = $this->holdback_finance;
		$myarray['term'] = $this->term;
		$myarray['rate'] = $this->rate;
		$myarray['monthly_payment'] = $this->monthly_payment;
		...
		$myarray['warranty_included'] = $this->warranty_included;
		$myarray['warranty_sold_outside'] = $this->warranty_sold_outside;
		...
		$myarray['finance_trade_allowance'] = $this->finance_trade_allowance;
	...
	public function from_array(&$data){
		...
		$this->set_sale_price_funding($data['sale_price_funding']);
		$this->set_stock($data['stock']);
		$this->set_date_sold(date('Y-m-d', strtotime($data['date_sold'])));
		$this->set_date_sent(date('Y-m-d', strtotime($data['date_sent'])));
		$this->set_down_payment($data['down_payment']);
		$this->set_guarantee($data['guarantee']);
		$this->set_holdback_finance($data['holdback_finance']);
		$this->set_term($data['term']);
		...
		$this->set_lender_id($data['lender_id']);
		$this->set_approved($data['approved']);
		$this->set_approved_date(date('Y-m-d', strtotime($data['approved_date'])));
		$this->set_funded($data['funded']);
		$this->set_funded_date(date('Y-m-d', strtotime($data['funded_date'])));
		$this->set_finance_person($data['finance_person']);
		$this->set_finance_payment($data['finance_payment']);
		$this->set_initial_gross($data['initial_gross']);
		$this->set_payable_gross($data['payable_gross']);
		...
		$this->set_flooring_id($data['flooring_id']);
		$this->set_flooring_paid($data['flooring_paid']);
		$this->set_flooring_date(date('Y-m-d', strtotime($data['flooring_date'])));
		$this->set_warranty_id($data['warranty_id']);
